...
One of the things Mirko likes to do with his intervals is "nest" them. An interval $$b$$ can nest inside another interval $$a$$ if $$b$$'s start point is greater than or equal to that of $$a$$, and $$b$$'s end point is less than or equal to that of $$a$$. If these conditions are met, we say $$a$$ contains $$b$$, or $$b$$ nests in $$a$$.
