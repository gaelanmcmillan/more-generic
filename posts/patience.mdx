...
## 0. The Problem
In early 2021, while working through the <ToolTip text="Kattis Archives">
    <div style={{whiteSpace: "pre", width: "fit-content"}}>[Kattis](https://open.kattis.com/) is a popular "online judge". <br/>Originating at the KTH in Sweden, it's now a favourite among competitive programmers.</div></ToolTip>, I came across a tricky problem.
